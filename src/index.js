...
import b_page_label from './components/pageLabel/pageLabel.vue'
import b_tab_bar from './components/tabBar/tabBar.vue'
import b_banner from './components/banner/banner.vue'
import b_side_bar from './components/sideBar/sideBar.vue'
import b_dot from './components/dot/dot.vue'
import b_head_bar from './components/headBar/headBar.vue'
...
export const A = b_a;
export const Banner = b_banner;
export const Button = b_button;
export const Footer = b_footer;
export const HeadBar = b_head_bar;
