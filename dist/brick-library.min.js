...
// module
exports.push([module.i, "\n.b_dot{position:fixed;bottom:100px;right:30px;display:flex;height:54px;width:54px;color:white;background-color:rgba(0,0,0,0.6);box-shadow:0 0 8px rgba(0,0,0,0.4);overflow:hidden\n}\n.b_dot:hover{cursor:pointer;background-color:rgba(66,185,131,0.9);box-shadow:0 0 12px rgba(66,185,131,0.9)\n}\n.b_dot_white{color:#161616;background-color:white\n}\n.b_dot_white:hover{color:white\n}\n.b_dot_slot{margin:auto;font-weight:bolder;font-size:14px\n}\n", "", {"version":3,"sources":["/项目/brick-library/src/components/dot/dot.vue"],"names":[],"mappings":";AAAA,OAAO,eAAe,aAAa,WAAW,aAAa,YAAY,WAAW,YAAY,iCAAiC,mCAAmC,eAAe;CAAC;AAAA,aAAa,eAAe,sCAAsC,wCAAwC;CAAC;AAAA,aAAa,cAAc,sBAAsB;CAAC;AAAA,mBAAmB,WAAW;CAAC;AAAA,YAAY,YAAY,mBAAmB,cAAc;CAAC","file":"dot.vue","sourcesContent":[".b_dot{position:fixed;bottom:100px;right:30px;display:flex;height:54px;width:54px;color:white;background-color:rgba(0,0,0,0.6);box-shadow:0 0 8px rgba(0,0,0,0.4);overflow:hidden}.b_dot:hover{cursor:pointer;background-color:rgba(66,185,131,0.9);box-shadow:0 0 12px rgba(66,185,131,0.9)}.b_dot_white{color:#161616;background-color:white}.b_dot_white:hover{color:white}.b_dot_slot{margin:auto;font-weight:bolder;font-size:14px}\n"],"sourceRoot":""}]);
